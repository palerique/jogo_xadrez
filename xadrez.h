...
#define LINHA_SUPERIOR 9
#define COLUNA_INFERIOR 1
#define COLUNA_SUPERIOR 9

char tabuleiro[11][11]= { 
  CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL,
  CHAR_VERTICAL, ESPACO_VAZIO, '1', '2', '3', '4', '5', '6', '7', '8', CHAR_VERTICAL,
  CHAR_VERTICAL, '1', TORRE_BRANCO, CAVALO_BRANCO, BISPO_BRANCO, REI_BRANCO, RAINHA_BRANCO, BISPO_BRANCO, CAVALO_BRANCO, TORRE_BRANCO, CHAR_VERTICAL,
  CHAR_VERTICAL, '2', PEAO_BRANCO, PEAO_BRANCO, PEAO_BRANCO, PEAO_BRANCO, PEAO_BRANCO, PEAO_BRANCO, PEAO_BRANCO, PEAO_BRANCO, CHAR_VERTICAL,
  CHAR_VERTICAL, '3', ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, CHAR_VERTICAL,
  CHAR_VERTICAL, '4', ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, CHAR_VERTICAL,
  CHAR_VERTICAL, '5', ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, CHAR_VERTICAL,
  CHAR_VERTICAL, '6', ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, ESPACO_VAZIO, CHAR_VERTICAL,
  CHAR_VERTICAL, '7', PEAO_PRETO, PEAO_PRETO, PEAO_PRETO, PEAO_PRETO, PEAO_PRETO, PEAO_PRETO, PEAO_PRETO, PEAO_PRETO, CHAR_VERTICAL,
  CHAR_VERTICAL, '8', TORRE_PRETO, CAVALO_PRETO, BISPO_PRETO, RAINHA_PRETO, REI_PRETO, BISPO_PRETO, CAVALO_PRETO, TORRE_PRETO, CHAR_VERTICAL,
  CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL, CHAR_HORIZONTAL
};
